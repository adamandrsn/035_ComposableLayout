...
import com.example.kotlinku.ui.theme.KotlinkuTheme
...
fun TampilLayar(pesan: String, dari: String){
    val image = painterResource(R.drawable.img_3)
    Box{
        Image(painter = image,
...
fun GreetingPreview() {
    KotlinkuTheme {
        TampilLayar("Assalamalaikum", dari = "Penghuni Surga")
    }
}